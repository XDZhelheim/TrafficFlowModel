...
def get_track(file_path):
    ...
    df_taxi["track"]=track
    df_taxi.to_csv("../data/taxi_after_proc/tracks_test/{}".format(file_path.split("/")[-1]), index=False)
    
    print("../data/taxi_after_proc/tracks_test/{}".format(file_path.split("/")[-1]))
...
if __name__ == "__main__":
    ...
    np.save("../data/trans_matirx_test.npy", trans_matrix)
